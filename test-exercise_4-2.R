...
test_that("Check `dimensions` variable", {
  expect_has_variable("dimensions", var_type="integer", envir=testEnv)
})

test_that("Check `dimensions` print out", {
  expect_printed("dimensions")
})
